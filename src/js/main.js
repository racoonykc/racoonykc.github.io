class GridAnimation {
	...
	drawGrid() {
		...
		gradient.addColorStop(0, "rgba(16, 21, 19, 0)");
		gradient.addColorStop(1, "#101513");
		...
		setTimeout(() => {
			...
			if (canvas) {
				const gridAnimation = new GridAnimation(canvas, {
					...
					borderColor: isPhone
						? "rgba(246, 241, 232, 0.2)"
						: "rgba(246, 241, 232, 0.1)",
					squareSize: isPhone ? 50 : 40,
					hoverFillColor: "rgba(246, 241, 232, 0.8)",
					hoverShadowColor: "rgba(246, 241, 232, 0.7)",
					transitionDuration: isPhone ? 150 : 200, // 移动端更快的过渡
					trailDuration: isPhone ? 2000 : 1500, // 移动端更长的痕迹
					specialBlockColor: "rgba(125, 63, 45, 0.84)",
					specialHoverColor: "rgba(64, 97, 93, 0.84)",
					// 蛇身颜色渐变配置
					snakeHeadColor: "rgba(246, 241, 232, 0.95)",
					snakeTailColor: "rgba(125, 63, 45, 0.25)",
